...
- **Unified Play v1** (`feature/worldmind-unified-play-v1`): visual gameplay shell + play API contract + runtime outcome/founder/rumor contracts. Se `docs/59_VISUAL_GAMEPLAY_SHELL_V1.md`, `docs/PLAY_API_CONTRACT.md`, `npm run validate:web-play`, `npm run validate:play-api`.
## Kør projektet
