...
- **Play API Contract v1** (`feature/play-api-contract-v1`): `GET /api/state` returnerer `gameShell` + `districtView` for eksterne klienter; se `docs/PLAY_API_CONTRACT.md` og `npm run validate:play-api`. Visual shell: PR #1.
## Kør projektet
