...
- **Visual Gameplay Shell v1** (`feature/visual-gameplay-shell-v1`): rigtig game-feel UI ovenpå live web play — topbar, asset-backed location scenes, hotspot cards, NPC portrait cards, case board tabs, rumor trail, founder panel, major-decision modal, live consequence ticker. `npm run validate:web-play` udvidet med visual markers + asset existence checks. Se `docs/59_VISUAL_GAMEPLAY_SHELL_V1.md`.
## Kør projektet
